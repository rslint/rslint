...
pub const AHOM: &'static [(char, char)] = &[('𑜀', '𑜚'), ('\u{1171d}', '\u{1172b}'), ('𑜰', '𑜿')];
...
pub const BOPOMOFO: &'static [(char, char)] = &[('˪', '˫'), ('ㄅ', 'ㄯ'), ('ㆠ', '\u{31bf}')];

pub const BRAHMI: &'static [(char, char)] = &[('𑀀', '𑁍'), ('𑁒', '𑁯'), ('\u{1107f}', '\u{1107f}')];
...
pub const CANADIAN_ABORIGINAL: &'static [(char, char)] = &[('᐀', 'ᙿ'), ('ᢰ', 'ᣵ')];

pub const CARIAN: &'static [(char, char)] = &[('𐊠', '𐋐')];

pub const CAUCASIAN_ALBANIAN: &'static [(char, char)] = &[('𐔰', '𐕣'), ('𐕯', '𐕯')];

pub const CHAKMA: &'static [(char, char)] = &[('\u{11100}', '\u{11134}'), ('𑄶', '\u{11147}')];
...
pub const EGYPTIAN_HIEROGLYPHS: &'static [(char, char)] = &[('𓀀', '𓐮'), ('\u{13430}', '\u{13438}')];
...
pub const KAITHI: &'static [(char, char)] = &[('\u{11080}', '𑃁'), ('\u{110cd}', '\u{110cd}')];
...
pub const LISU: &'static [(char, char)] = &[('ꓐ', '꓿'), ('\u{11fb0}', '\u{11fb0}')];
