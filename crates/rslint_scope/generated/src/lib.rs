...
decl_update_deserializer!(
    UpdateSerializer,
    (7, types__config::EnableNoUnusedVars),
    (8, types__inputs::Array),
    (9, types__inputs::Arrow),
    (10, types__inputs::ArrowParam),
    (11, types__inputs::Assign),
    (12, types__inputs::Await),
    (13, types__inputs::BinOp),
    (14, types__inputs::BracketAccess),
    (15, types__inputs::Break),
    (16, types__inputs::Call),
    (17, types__inputs::Class),
    (18, types__inputs::ClassExpr),
    (19, types__inputs::ConstDecl),
    (20, types__inputs::Continue),
    (21, types__inputs::DoWhile),
    (22, types__inputs::DotAccess),
    (23, types__inputs::EveryScope),
    (24, types__inputs::ExprBigInt),
    (25, types__inputs::ExprBool),
    (26, types__inputs::ExprNumber),
    (27, types__inputs::ExprString),
    (28, types__inputs::Expression),
    (29, types__inputs::File),
    (30, types__inputs::FileExport),
    (31, types__inputs::For),
    (32, types__inputs::ForIn),
    (33, types__inputs::ForOf),
    (34, types__inputs::Function),
    (35, types__inputs::FunctionArg),
    (36, types__inputs::If),
    (37, types__inputs::ImplicitGlobal),
    (38, types__inputs::ImportDecl),
    (39, types__inputs::InlineFunc),
    (40, types__inputs::InlineFuncParam),
    (41, types__inputs::InputScope),
    (42, types__inputs::Label),
    (43, types__inputs::LetDecl),
    (44, types__inputs::NameRef),
    (45, types__inputs::New),
    (46, types__inputs::Property),
    (47, types__inputs::Return),
    (48, types__inputs::Statement),
    (49, types__inputs::Switch),
    (50, types__inputs::SwitchCase),
    (51, types__inputs::Template),
    (52, types__inputs::Ternary),
    (53, types__inputs::Throw),
    (54, types__inputs::Try),
    (55, types__inputs::UnaryOp),
    (56, types__inputs::UserGlobal),
    (57, types__inputs::VarDecl),
    (58, types__inputs::While),
    (59, types__inputs::With),
    (60, types__inputs::Yield),
    (66, types::outputs::no_shadow::NoShadow),
    (69, types::outputs::no_undef::NoUndef),
    (71, types__outputs__no_unused_labels::NoUnusedLabels),
    (72, types__outputs__no_unused_labels::UsedLabels),
    (75, types::outputs::typeof_undef::TypeofUndef),
    (78, types::outputs::unused_vars::UnusedVariables),
    (79, types::outputs::use_before_def::UseBeforeDef)
);
impl TryFrom<&str> for Relations {
    ...
    fn try_from(rname: &str) -> ::std::result::Result<Self, ()> {
        match rname {
            ...
            "outputs::no_unused_labels::__Prefix_3" => {
                Ok(Relations::outputs_no_unused_labels___Prefix_3)
            }
            "outputs::no_unused_labels::__Prefix_6" => {
                Ok(Relations::outputs_no_unused_labels___Prefix_6)
            }
            "outputs::typeof_undef::TypeofUndef" => Ok(Relations::outputs_typeof_undef_TypeofUndef),
            "outputs::typeof_undef::WithinTypeofExpr" => {
                Ok(Relations::outputs_typeof_undef_WithinTypeofExpr)
            }
            ...
            "outputs::use_before_def::UseBeforeDef" => {
                Ok(Relations::outputs_use_before_def_UseBeforeDef)
            }
    ...
    pub fn type_id(&self) -> ::std::any::TypeId {
        match self {
            Relations::__Prefix_0 => ::std::any::TypeId::of::<
                ...
                >,
            >(),
            Relations::__Prefix_1 => ::std::any::TypeId::of::<
                ddlog_std::tuple6<
                    types__ast::FileId,
                    types__config::Config,
                    types__ast::ExprId,
                ...
                >,
            >(),
            Relations::__Prefix_2 => ::std::any::TypeId::of::<
                ddlog_std::tuple4<
                    types__ast::FileId,
                    types__config::Config,
                    types__ast::ExprId,
                ...
                >,
            >(),
            Relations::__Prefix_4 => ::std::any::TypeId::of::<
                ddlog_std::tuple2<types__ast::FileId, types__config::Config>,
            >(),
            Relations::__Prefix_5 => ::std::any::TypeId::of::<
                ddlog_std::tuple2<types__ast::FileId, types__config::Config>,
            >(),
            Relations::__Prefix_7 => ::std::any::TypeId::of::<
                ddlog_std::tuple2<types__ast::FileId, types__config::Config>,
            >(),
            Relations::__Prefix_8 => ::std::any::TypeId::of::<
                ddlog_std::tuple2<types__ast::FileId, types__config::Config>,
            >(),
            ...
            Relations::outputs_no_unused_labels___Prefix_3 => ::std::any::TypeId::of::<
                ddlog_std::tuple5<
                    types__ast::FileId,
                    types__config::Config,
                    types__ast::StmtId,
                ...
                >,
            >(),
            Relations::outputs_no_unused_labels___Prefix_6 => ::std::any::TypeId::of::<
                ddlog_std::tuple2<types__ast::FileId, types__config::Config>,
            >(),
            Relations::outputs_typeof_undef_TypeofUndef => {
                ::std::any::TypeId::of::<types::outputs::typeof_undef::TypeofUndef>()
            }
            Relations::outputs_typeof_undef_WithinTypeofExpr => {
                ::std::any::TypeId::of::<types::outputs::typeof_undef::WithinTypeofExpr>()
            }
            ...
            Relations::outputs_use_before_def_UseBeforeDef => {
                ::std::any::TypeId::of::<types::outputs::use_before_def::UseBeforeDef>()
            }
...
pub static RELIDMAP: ::once_cell::sync::Lazy<::fnv::FnvHashMap<Relations, &'static str>> =
    ::once_cell::sync::Lazy::new(|| {
        ...
        map.insert(
            Relations::outputs_typeof_undef_TypeofUndef,
            "outputs::typeof_undef::TypeofUndef",
        );
        map.insert(
            Relations::outputs_typeof_undef_WithinTypeofExpr,
            "outputs::typeof_undef::WithinTypeofExpr",
...
> = ::once_cell::sync::Lazy::new(|| {
    ...
    map.insert(
        1,
        ::std::ffi::CStr::from_bytes_with_nul(b"__Prefix_1\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        2,
        ::std::ffi::CStr::from_bytes_with_nul(b"__Prefix_2\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        3,
        ::std::ffi::CStr::from_bytes_with_nul(b"__Prefix_4\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        4,
        ::std::ffi::CStr::from_bytes_with_nul(b"__Prefix_5\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        5,
        ::std::ffi::CStr::from_bytes_with_nul(b"__Prefix_7\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        6,
        ::std::ffi::CStr::from_bytes_with_nul(b"__Prefix_8\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        7,
    ...
    map.insert(
        73,
        ::std::ffi::CStr::from_bytes_with_nul(b"outputs::no_unused_labels::__Prefix_3\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        74,
        ::std::ffi::CStr::from_bytes_with_nul(b"outputs::no_unused_labels::__Prefix_6\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        75,
        ::std::ffi::CStr::from_bytes_with_nul(b"outputs::typeof_undef::TypeofUndef\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        76,
        ::std::ffi::CStr::from_bytes_with_nul(b"outputs::typeof_undef::WithinTypeofExpr\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        77,
    ...
    map.insert(
        79,
        ::std::ffi::CStr::from_bytes_with_nul(b"outputs::use_before_def::UseBeforeDef\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        80,
...
pub static INPUT_RELIDMAP: ::once_cell::sync::Lazy<::fnv::FnvHashMap<Relations, &'static str>> =
    ::once_cell::sync::Lazy::new(|| {
        let mut map =
            ::fnv::FnvHashMap::with_capacity_and_hasher(54, ::fnv::FnvBuildHasher::default());
        map.insert(
            Relations::config_EnableNoUnusedVars,
            "config::EnableNoUnusedVars",
        );
...
> = ::once_cell::sync::Lazy::new(|| {
    ...
    map.insert(
        0,
        ::std::ffi::CStr::from_bytes_with_nul(b"inputs::EveryScopeByFile\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        1,
        ::std::ffi::CStr::from_bytes_with_nul(b"inputs::ExpressionByFile\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        2,
    ...
    map.insert(
        3,
        ::std::ffi::CStr::from_bytes_with_nul(b"inputs::ExpressionBySpan\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        4,
        ::std::ffi::CStr::from_bytes_with_nul(b"inputs::FileById\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        5,
        ::std::ffi::CStr::from_bytes_with_nul(b"inputs::InputScopeByChild\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        6,
        ::std::ffi::CStr::from_bytes_with_nul(b"inputs::InputScopeByFile\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        7,
        ::std::ffi::CStr::from_bytes_with_nul(b"inputs::InputScopeByParent\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        8,
        ::std::ffi::CStr::from_bytes_with_nul(b"inputs::StatementByFile\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        9,
    ...
    map.insert(
        10,
        ::std::ffi::CStr::from_bytes_with_nul(b"inputs::StatementBySpan\0")
            .expect("Unreachable: A null byte was specifically inserted"),
    );
    map.insert(
        11,
...
pub fn relval_from_record(
    ...
    match rel {
        Relations::__Prefix_0 => Ok(<ddlog_std::tuple7<
            types__ast::FileId,
            types__config::Config,
            types__ast::ExprId,
            types__ast::ExprId,
        ...
        >>::from_record(_rec)?
        .into_ddvalue()),
        Relations::__Prefix_1 => Ok(<ddlog_std::tuple6<
            types__ast::FileId,
            types__config::Config,
            types__ast::ExprId,
            types__ast::ExprId,
        ...
        >>::from_record(_rec)?
        .into_ddvalue()),
        Relations::__Prefix_2 => Ok(<ddlog_std::tuple4<
            types__ast::FileId,
            types__config::Config,
            types__ast::ExprId,
            types__ast::ExprId,
        >>::from_record(_rec)?
        .into_ddvalue()),
        Relations::__Prefix_4 => Ok(
            <ddlog_std::tuple2<types__ast::FileId, types__config::Config>>::from_record(_rec)?
                .into_ddvalue(),
        ),
        Relations::__Prefix_5 => Ok(
            <ddlog_std::tuple2<types__ast::FileId, types__config::Config>>::from_record(_rec)?
                .into_ddvalue(),
        ),
        Relations::__Prefix_7 => Ok(
            <ddlog_std::tuple2<types__ast::FileId, types__config::Config>>::from_record(_rec)?
                .into_ddvalue(),
        ),
        Relations::__Prefix_8 => Ok(
            <ddlog_std::tuple2<types__ast::FileId, types__config::Config>>::from_record(_rec)?
                .into_ddvalue(),
        ),
        Relations::config_EnableNoUnusedVars => {
        ...
        Relations::outputs_no_unused_labels___Prefix_3 => Ok(<ddlog_std::tuple5<
            types__ast::FileId,
            types__config::Config,
            types__ast::StmtId,
        ...
        >>::from_record(_rec)?
        .into_ddvalue()),
        Relations::outputs_no_unused_labels___Prefix_6 => Ok(<ddlog_std::tuple2<
            types__ast::FileId,
            types__config::Config,
        >>::from_record(_rec)?
        .into_ddvalue()),
...
pub fn relkey_from_record(
    ...
    match rel {
        ...
        Relations::inputs_Class => Ok(
            <ddlog_std::tuple2<types__ast::ClassId, types__ast::FileId>>::from_record(_rec)?
                .into_ddvalue(),
        ),
        Relations::inputs_Expression => Ok(<ddlog_std::tuple2<
            types__ast::ExprId,
            types__ast::FileId,
        >>::from_record(_rec)?
        .into_ddvalue()),
        Relations::inputs_File => Ok(<types__ast::FileId>::from_record(_rec)?.into_ddvalue()),
        Relations::inputs_Function => Ok(<ddlog_std::tuple2<
            types__ast::FuncId,
            types__ast::FileId,
        >>::from_record(_rec)?
        .into_ddvalue()),
        Relations::inputs_Statement => Ok(<ddlog_std::tuple2<
            types__ast::StmtId,
            types__ast::FileId,
        >>::from_record(_rec)?
        .into_ddvalue()),
...
pub fn idxkey_from_record(
    ...
    match idx {
        ...
        Indexes::inputs_ExpressionById => Ok(<ddlog_std::tuple2<
            types__ast::ExprId,
            types__ast::FileId,
        >>::from_record(_rec)?
        .into_ddvalue()),
        Indexes::inputs_ExpressionBySpan => Ok(<ddlog_std::tuple2<
            types__ast::Span,
            types__ast::FileId,
        >>::from_record(_rec)?
        .into_ddvalue()),
        Indexes::inputs_FileById => Ok(<types__ast::FileId>::from_record(_rec)?.into_ddvalue()),
        Indexes::inputs_InputScopeByChild => Ok(<ddlog_std::tuple2<
            types__ast::ScopeId,
            types__ast::FileId,
        >>::from_record(_rec)?
        .into_ddvalue()),
        ...
        Indexes::inputs_InputScopeByParent => Ok(<ddlog_std::tuple2<
            types__ast::ScopeId,
            types__ast::FileId,
        >>::from_record(_rec)?
        .into_ddvalue()),
        ...
        Indexes::inputs_StatementById => Ok(<ddlog_std::tuple2<
            types__ast::StmtId,
            types__ast::FileId,
        >>::from_record(_rec)?
        .into_ddvalue()),
        Indexes::inputs_StatementBySpan => Ok(<ddlog_std::tuple2<
            types__ast::Span,
            types__ast::FileId,
        >>::from_record(_rec)?
        .into_ddvalue()),
        Indexes::name_in_scope_Index_VariableInScope => Ok(<ddlog_std::tuple3<
            types__ast::FileId,
            types__ast::ScopeId,
            internment::Intern<String>,
        >>::from_record(_rec)?
        .into_ddvalue()),
        Indexes::name_in_scope_Index_VariablesForScope => Ok(<ddlog_std::tuple2<
            types__ast::FileId,
            types__ast::ScopeId,
        >>::from_record(_rec)?
        .into_ddvalue()),
        Indexes::scopes_ScopeFamilyByParent => Ok(<ddlog_std::tuple2<
            types__ast::ScopeId,
            types__ast::FileId,
        >>::from_record(_rec)?
        .into_ddvalue()),
...
pub fn prog(__update_cb: Box<dyn program::CBFn>) -> program::Program {
    let config_EnableNoUnusedVars = program::Relation {
        ...
        id: 7,
        rules: vec![],
        arrangements: vec![types__config::__Arng_config_EnableNoUnusedVars_0.clone()],
        change_cb: None,
    };
    ...
    let inputs_EveryScope = program::Relation {
        ...
        id: 23,
        rules: vec![],
        arrangements: vec![types__inputs::__Arng_inputs_EveryScope_0.clone()],
        change_cb: None,
    };
    ...
    let __Prefix_4 = program::Relation {
        ...
        key_func: None,
        id: 3,
        rules: vec![types::__Rule___Prefix_4_0.clone()],
        arrangements: vec![types::__Arng___Prefix_4_0.clone()],
        change_cb: None,
    };
    let __Prefix_5 = program::Relation {
        ...
        key_func: None,
        id: 4,
        rules: vec![types::__Rule___Prefix_5_0.clone()],
        arrangements: vec![types::__Arng___Prefix_5_0.clone()],
        change_cb: None,
    };
    let __Prefix_7 = program::Relation {
        ...
        key_func: None,
        id: 5,
        rules: vec![types::__Rule___Prefix_7_0.clone()],
        arrangements: vec![types::__Arng___Prefix_7_0.clone()],
        change_cb: None,
    };
    ...
    let __Prefix_8 = program::Relation {
        ...
        key_func: None,
        id: 6,
        rules: vec![types::__Rule___Prefix_8_0.clone()],
        arrangements: vec![types::__Arng___Prefix_8_0.clone()],
        change_cb: None,
    };
    ...
    let __Prefix_1 = program::Relation {
        ...
        key_func: None,
        id: 1,
        rules: vec![types::__Rule___Prefix_1_0.clone()],
        arrangements: vec![
    ...
    let __Prefix_2 = program::Relation {
        ...
        key_func: None,
        id: 2,
        rules: vec![types::__Rule___Prefix_2_0.clone()],
        arrangements: vec![types::__Arng___Prefix_2_0.clone()],
        change_cb: None,
    };
    ...
    let nodes: std::vec::Vec<program::ProgNode> = vec![
        ...
        program::ProgNode::Rel {
            rel: outputs_no_unused_labels___Prefix_6,
        },
        program::ProgNode::Rel {
        ...
        program::ProgNode::Rel {
            rel: outputs_no_unused_labels___Prefix_3,
        },
        program::ProgNode::Rel {
            rel: inputs_LetDecl,
        },
        ...
        program::ProgNode::SCC {
            rels: vec![
                program::RecursiveRelation {
                    rel: __Prefix_2,
                    distinct: true,
                },
                program::RecursiveRelation {
                    rel: outputs_typeof_undef_WithinTypeofExpr,
                    distinct: true,
                },
            ],
        },
        ...
        program::ProgNode::Rel {
            rel: outputs_typeof_undef_TypeofUndef,
        },
        program::ProgNode::Rel {
        ...
        program::ProgNode::Rel {
            rel: outputs_use_before_def_UseBeforeDef,
        },
        program::ProgNode::Rel {
