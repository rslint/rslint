...
impl TryFrom<&str> for Relations {
    ...
    fn try_from(rname: &str) -> ::std::result::Result<Self, ()> {
        ...
        "outputs::no_undef::GloballessNoUndef" => Ok(Relations::outputs_no_undef_GloballessNoUndef),
...
impl Relations {
    pub fn type_id(&self) -> ::std::any::TypeId {
        match self {
            ...
            Relations::outputs_no_undef_GloballessNoUndef => ::std::any::TypeId::of::<types::outputs::no_undef::GloballessNoUndef>(),
...
pub static RELIDMAP: ::once_cell::sync::Lazy<::fnv::FnvHashMap<Relations, &'static str>> =
    ::once_cell::sync::Lazy::new(|| {
        ...
        map.insert(Relations::outputs_no_undef_GloballessNoUndef, "outputs::no_undef::GloballessNoUndef");
...
pub fn prog(__update_cb: std::sync::Arc<dyn program::RelationCallback>) -> program::Program {
    ...
    let name_in_scope_NeedsSymbolResolution = program::Relation {
                                                  name:         std::borrow::Cow::from("name_in_scope::NeedsSymbolResolution"),
                                                  input:        false,
                                                  distinct:     false,
                                                  caching_mode: program::CachingMode::Set,
                                                  key_func:     None,
                                                  ...
                                                  rules:        vec![
                                                      ...
                                                      types::name_in_scope::__Rule_name_in_scope_NeedsSymbolResolution_2.clone(),
    ...
    let nodes: std::vec::Vec<program::ProgNode> = vec![
            ...
            program::ProgNode::Rel{rel: name_in_scope_NeedsSymbolResolution},
