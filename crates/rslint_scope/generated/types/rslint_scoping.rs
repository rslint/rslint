...
pub static __STATIC_0: ::once_cell::sync::Lazy<ddlog_std::Ref<crate::var_decls::VariableMeta>> =
    ::once_cell::sync::Lazy::new(|| {
        ddlog_std::ref_new(
            (&(crate::var_decls::VariableMeta {
                is_function_argument: false,
                implicitly_declared: false,
                declaration_span: (ddlog_std::Option::None {}),
            })),
        )
    });
pub static __STATIC_1: ::once_cell::sync::Lazy<ddlog_std::Ref<crate::var_decls::VariableMeta>> =
    ::once_cell::sync::Lazy::new(|| {
        ddlog_std::ref_new(
            (&(crate::var_decls::VariableMeta {
...
pub static __Arng___Prefix_4_0: ::once_cell::sync::Lazy<program::Arrangement> =
    ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
        ...
        afun: {
            fn __f(__v: DDValue) -> Option<(DDValue, DDValue)> {
                ...
                match <ddlog_std::tuple2<types__ast::FileId, types__config::Config>>::from_ddvalue(
                    __v,
                ) {
...
pub static __Arng___Prefix_5_0: ::once_cell::sync::Lazy<program::Arrangement> =
    ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
        name: std::borrow::Cow::from(r###"((_0: ast::FileId), (_: config::Config)) /*join*/"###),
        afun: {
            fn __f(__v: DDValue) -> Option<(DDValue, DDValue)> {
...
pub static __Arng___Prefix_7_0: ::once_cell::sync::Lazy<program::Arrangement> =
    ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
        name: std::borrow::Cow::from(r###"((_0: ast::FileId), (_: config::Config)) /*join*/"###),
        afun: {
            fn __f(__v: DDValue) -> Option<(DDValue, DDValue)> {
...
pub static __Arng___Prefix_8_0: ::once_cell::sync::Lazy<program::Arrangement> =
    ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
        name: std::borrow::Cow::from(r###"((_0: ast::FileId), (_: config::Config)) /*join*/"###),
        afun: {
            fn __f(__v: DDValue) -> Option<(DDValue, DDValue)> {
...
pub static __Arng___Prefix_1_0: ::once_cell::sync::Lazy<program::Arrangement> =
    ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
        name: std::borrow::Cow::from(
            r###"((_1: ast::FileId), (_: config::Config), (_: ast::ExprId), (_0: ast::ExprId), (_: ast::ScopeId), (_: ast::Span)) /*join*/"###,
        ),
        afun: {
            fn __f(__v: DDValue) -> Option<(DDValue, DDValue)> {
                let __cloned = __v.clone();
                match <ddlog_std::tuple6<
                    types__ast::FileId,
                ...
                >>::from_ddvalue(__v)
                {
                    ddlog_std::tuple6(ref _1, _, _, ref _0, _, _) => {
...
pub static __Arng___Prefix_1_1: ::once_cell::sync::Lazy<program::Arrangement> =
    ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
        name: std::borrow::Cow::from(
            r###"((_0: ast::FileId), (_: config::Config), (_: ast::ExprId), (_: ast::ExprId), (_: ast::ScopeId), (_: ast::Span)) /*join*/"###,
        ),
        afun: {
            fn __f(__v: DDValue) -> Option<(DDValue, DDValue)> {
                let __cloned = __v.clone();
                ...
                >>::from_ddvalue(__v)
                {
                    ddlog_std::tuple6(ref _0, _, _, _, _, _) => {
...
pub static __Arng___Prefix_0_0: ::once_cell::sync::Lazy<program::Arrangement> =
    ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
        name: std::borrow::Cow::from(
            r###"((_0: ast::FileId), (_: config::Config), (_: ast::ExprId), (_: ast::ExprId), (_2: ast::ScopeId), (_: ast::Span), (_1: internment::Intern<string>)) /*join*/"###,
        ),
        afun: {
            fn __f(__v: DDValue) -> Option<(DDValue, DDValue)> {
                let __cloned = __v.clone();
                match <ddlog_std::tuple7<
                    types__ast::FileId,
                    types__config::Config,
                    types__ast::ExprId,
                    types__ast::ExprId,
                ...
                >>::from_ddvalue(__v)
                {
                    ddlog_std::tuple7(ref _0, _, _, _, ref _2, _, ref _1) => Some(
...
pub static __Arng___Prefix_0_1: ::once_cell::sync::Lazy<program::Arrangement> =
    ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
        name: std::borrow::Cow::from(
            r###"((_0: ast::FileId), (_: config::Config), (_: ast::ExprId), (_: ast::ExprId), (_: ast::ScopeId), (_: ast::Span), (_1: internment::Intern<string>)) /*join*/"###,
        ),
        afun: {
            fn __f(__v: DDValue) -> Option<(DDValue, DDValue)> {
                let __cloned = __v.clone();
                ...
                >>::from_ddvalue(__v)
                {
                    ddlog_std::tuple7(ref _0, _, _, _, _, _, ref _1) => {
                        Some((ddlog_std::tuple2((*_0).clone(), (*_1).clone())).into_ddvalue())
                    }
                    _ => None,
                }
...
pub static __Arng___Prefix_2_0: ::once_cell::sync::Lazy<program::Arrangement> =
    ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
        name: std::borrow::Cow::from(
            r###"((_1: ast::FileId), (_: config::Config), (_: ast::ExprId), (_0: ast::ExprId)) /*join*/"###,
        ),
        afun: {
            fn __f(__v: DDValue) -> Option<(DDValue, DDValue)> {
                let __cloned = __v.clone();
                match <ddlog_std::tuple4<
                    types__ast::FileId,
                    types__config::Config,
                    types__ast::ExprId,
                    types__ast::ExprId,
                >>::from_ddvalue(__v)
                {
                    ddlog_std::tuple4(ref _1, _, _, ref _0) => {
                        Some((ddlog_std::tuple2((*_0).clone(), (*_1).clone())).into_ddvalue())
                    }
                    _ => None,
                }
...
pub static __Rule___Prefix_4_0: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* __Prefix_4[((file: ast::FileId), (config: config::Config))] :- inputs::File[(inputs::File{.id=(file: ast::FileId), .kind=(_: ast::FileKind), .top_level_scope=(_: ast::ScopeId), .config=(config: config::Config)}: inputs::File)], ((config::no_undef_enabled(config)) or (config::no_typeof_undef_enabled(config))). */
...
pub static __Rule___Prefix_5_0: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* __Prefix_5[((file: ast::FileId), (config: config::Config))] :- inputs::File[(inputs::File{.id=(file: ast::FileId), .kind=(_: ast::FileKind), .top_level_scope=(_: ast::ScopeId), .config=(config: config::Config)}: inputs::File)], (config::no_use_before_def_enabled(config)). */
                                                                                                          program::Rule::CollectionRule {
...
pub static __Rule___Prefix_7_0: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* __Prefix_7[((file: ast::FileId), (config: config::Config))] :- inputs::File[(inputs::File{.id=(file: ast::FileId), .kind=(_: ast::FileKind), .top_level_scope=(_: ast::ScopeId), .config=(config: config::Config)}: inputs::File)], (config::no_undef_enabled(config)). */
                                                                                                          program::Rule::CollectionRule {
                                                                                                              description: std::borrow::Cow::from("__Prefix_7[(file, config)] :- inputs::File(.id=file, .kind=_, .top_level_scope=_, .config=config), (config::no_undef_enabled(config))."),
                                                                                                              rel: 29,
                                                                                                              xform: Some(XFormCollection::FilterMap{
                                                                                                                              description: std::borrow::Cow::from("head of __Prefix_7[(file, config)] :- inputs::File(.id=file, .kind=_, .top_level_scope=_, .config=config), (config::no_undef_enabled(config))."),
                                                                                                                              fmfun: {fn __f(__v: DDValue) -> Option<DDValue>
                                                                                                                              {
                                                                                                                                  let (ref file, ref config) = match *<types__inputs::File>::from_ddvalue_ref(&__v) {
                                                                                                                                      types__inputs::File{id: ref file, kind: _, top_level_scope: _, config: ref config} => ((*file).clone(), (*config).clone()),
...
pub static __Rule___Prefix_8_0: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* __Prefix_8[((file: ast::FileId), (config: config::Config))] :- inputs::File[(inputs::File{.id=(file: ast::FileId), .kind=(_: ast::FileKind), .top_level_scope=(_: ast::ScopeId), .config=(config: config::Config)}: inputs::File)], (config::no_shadow_enabled(config)). */
                                                                                                          program::Rule::CollectionRule {
                                                                                                              description: std::borrow::Cow::from("__Prefix_8[(file, config)] :- inputs::File(.id=file, .kind=_, .top_level_scope=_, .config=config), (config::no_shadow_enabled(config))."),
                                                                                                              rel: 29,
                                                                                                              xform: Some(XFormCollection::FilterMap{
                                                                                                                              description: std::borrow::Cow::from("head of __Prefix_8[(file, config)] :- inputs::File(.id=file, .kind=_, .top_level_scope=_, .config=config), (config::no_shadow_enabled(config))."),
                                                                                                                              fmfun: {fn __f(__v: DDValue) -> Option<DDValue>
                                                                                                                              {
                                                                                                                                  let (ref file, ref config) = match *<types__inputs::File>::from_ddvalue_ref(&__v) {
                                                                                                                                      types__inputs::File{id: ref file, kind: _, top_level_scope: _, config: ref config} => ((*file).clone(), (*config).clone()),
...
pub static __Rule___Prefix_1_0: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* __Prefix_1[((file: ast::FileId), (config: config::Config), (expr: ast::ExprId), (object: ast::ExprId), (used_scope: ast::ScopeId), (used_in: ast::Span))] :- __Prefix_5[((file: ast::FileId), (config: config::Config))], inputs::New[(inputs::New{.expr_id=(expr: ast::ExprId), .file=(file: ast::FileId), .object=(ddlog_std::Some{.x=(object: ast::ExprId)}: ddlog_std::Option<ast::ExprId>), .args=(_: ddlog_std::Option<ddlog_std::Vec<ast::ExprId>>)}: inputs::New)], inputs::Expression[(inputs::Expression{.id=(expr: ast::ExprId), .file=(file: ast::FileId), .kind=(_: ast::ExprKind), .scope=(used_scope: ast::ScopeId), .span=(used_in: ast::Span)}: inputs::Expression)]. */
...
pub static __Rule___Prefix_0_0: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
...
pub static __Rule___Prefix_2_0: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* __Prefix_2[((file: ast::FileId), (config: config::Config), (type_of: ast::ExprId), (expr: ast::ExprId))] :- __Prefix_4[((file: ast::FileId), (config: config::Config))], outputs::typeof_undef::WithinTypeofExpr[(outputs::typeof_undef::WithinTypeofExpr{.type_of=(type_of: ast::ExprId), .expr=(expr: ast::ExprId), .file=(file: ast::FileId)}: outputs::typeof_undef::WithinTypeofExpr)]. */
                                                                                                          program::Rule::ArrangementRule {
