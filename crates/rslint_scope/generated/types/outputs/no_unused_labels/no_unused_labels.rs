...
pub static __Arng_outputs_no_unused_labels___Prefix_1_0: ::once_cell::sync::Lazy<
    program::Arrangement,
> = ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
    name: std::borrow::Cow::from(
        r###"((_: ast::FileId), (_: ast::StmtId), ((ast::Spanned{.data=_0, .span=_}: ast::Spanned{data: ast::Name, span: ast::Span}): ast::Spanned<ast::Name>), (_1: ast::ScopeId)) /*join*/"###,
    ),
    afun: {
...
pub static __Arng_outputs_no_unused_labels___Prefix_1_1: ::once_cell::sync::Lazy<
    program::Arrangement,
> = ::once_cell::sync::Lazy::new(|| program::Arrangement::Map {
    name: std::borrow::Cow::from(
        r###"((_: ast::FileId), (_: ast::StmtId), (_: ast::Spanned<ast::Name>), (_0: ast::ScopeId)) /*join*/"###,
    ),
    afun: {
        fn __f(__v: DDValue) -> Option<(DDValue, DDValue)> {
            let __cloned = __v.clone();
...
> = ::once_cell::sync::Lazy::new(|| program::Arrangement::Set {
    name: std::borrow::Cow::from(
        r###"(outputs::no_unused_labels::LabelUsage{.stmt=(_: ast::StmtId), .label_name=_0, .scope=(_1: ast::ScopeId)}: outputs::no_unused_labels::LabelUsage) /*semijoin*/"###,
    ),
    fmfun: {
...
> = ::once_cell::sync::Lazy::new(|| program::Arrangement::Set {
    name: std::borrow::Cow::from(
        r###"(outputs::no_unused_labels::LabelUsage{.stmt=(_: ast::StmtId), .label_name=(_0: internment::Intern<string>), .scope=(_1: ast::ScopeId)}: outputs::no_unused_labels::LabelUsage) /*antijoin*/"###,
    ),
    fmfun: {
        fn __f(__v: DDValue) -> Option<DDValue> {
            match <LabelUsage>::from_ddvalue(__v) {
...
> = ::once_cell::sync::Lazy::new(|| program::Arrangement::Set {
    name: std::borrow::Cow::from(
        r###"(outputs::no_unused_labels::UsedLabels{.stmt_id=(_0: ast::StmtId), .label_name=_1}: outputs::no_unused_labels::UsedLabels) /*antijoin*/"###,
    ),
    fmfun: {
        fn __f(__v: DDValue) -> Option<DDValue> {
...
pub static __Rule_outputs_no_unused_labels_LabelUsage_0: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* outputs::no_unused_labels::LabelUsage[(outputs::no_unused_labels::LabelUsage{.stmt=stmt, .label_name=name, .scope=scope}: outputs::no_unused_labels::LabelUsage)] :- config::EnableNoUnusedLabels[(config::EnableNoUnusedLabels{.file=(file: ast::FileId), .config=(_: ddlog_std::Ref<config::NoUnusedLabelsConfig>)}: config::EnableNoUnusedLabels)], inputs::Break[(inputs::Break{.stmt_id=(stmt@ (ast::StmtId{.id=(_: bit<32>), .file=(file: ast::FileId)}: ast::StmtId)), .label=(ddlog_std::Some{.x=(ast::Spanned{.data=(name: internment::Intern<string>), .span=(_: ast::Span)}: ast::Spanned<internment::Intern<string>>)}: ddlog_std::Option<ast::Spanned<internment::Intern<string>>>)}: inputs::Break)], inputs::Statement[(inputs::Statement{.id=(stmt: ast::StmtId), .kind=(_: ast::StmtKind), .scope=(scope: ast::ScopeId), .span=(_: ast::Span)}: inputs::Statement)]. */
                                                                                                                                   program::Rule::ArrangementRule {
...
pub static __Rule_outputs_no_unused_labels_LabelUsage_1: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* outputs::no_unused_labels::LabelUsage[(outputs::no_unused_labels::LabelUsage{.stmt=stmt, .label_name=name, .scope=scope}: outputs::no_unused_labels::LabelUsage)] :- config::EnableNoUnusedLabels[(config::EnableNoUnusedLabels{.file=(file: ast::FileId), .config=(_: ddlog_std::Ref<config::NoUnusedLabelsConfig>)}: config::EnableNoUnusedLabels)], inputs::Continue[(inputs::Continue{.stmt_id=(stmt@ (ast::StmtId{.id=(_: bit<32>), .file=(file: ast::FileId)}: ast::StmtId)), .label=(ddlog_std::Some{.x=(ast::Spanned{.data=(name: internment::Intern<string>), .span=(_: ast::Span)}: ast::Spanned<internment::Intern<string>>)}: ddlog_std::Option<ast::Spanned<internment::Intern<string>>>)}: inputs::Continue)], inputs::Statement[(inputs::Statement{.id=(stmt: ast::StmtId), .kind=(_: ast::StmtKind), .scope=(scope: ast::ScopeId), .span=(_: ast::Span)}: inputs::Statement)]. */
                                                                                                                                   program::Rule::ArrangementRule {
...
pub static __Rule_scopes_NeedsScopeChildren_0: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* scopes::NeedsScopeChildren[(scopes::NeedsScopeChildren{.scope=scope}: scopes::NeedsScopeChildren)] :- config::EnableNoUnusedLabels[(config::EnableNoUnusedLabels{.file=(file: ast::FileId), .config=(_: ddlog_std::Ref<config::NoUnusedLabelsConfig>)}: config::EnableNoUnusedLabels)], inputs::Label[(inputs::Label{.stmt_id=(ast::StmtId{.id=(_: bit<32>), .file=(file: ast::FileId)}: ast::StmtId), .name=(ddlog_std::Some{.x=(ast::Spanned{.data=(name: internment::Intern<string>), .span=(_: ast::Span)}: ast::Spanned<internment::Intern<string>>)}: ddlog_std::Option<ast::Spanned<internment::Intern<string>>>), .body=(_: ddlog_std::Option<ast::StmtId>), .body_scope=(scope: ast::ScopeId)}: inputs::Label)], not outputs::no_unused_labels::LabelUsage[(outputs::no_unused_labels::LabelUsage{.stmt=(_: ast::StmtId), .label_name=(name: internment::Intern<string>), .scope=(scope: ast::ScopeId)}: outputs::no_unused_labels::LabelUsage)]. */
                                                                                                                         program::Rule::ArrangementRule {
...
pub static __Rule_outputs_no_unused_labels_UsedLabels_0: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* outputs::no_unused_labels::UsedLabels[(outputs::no_unused_labels::UsedLabels{.stmt_id=stmt, .label_name=(name.data)}: outputs::no_unused_labels::UsedLabels)] :- outputs::no_unused_labels::__Prefix_1[((file: ast::FileId), (stmt: ast::StmtId), (name: ast::Spanned<ast::Name>), (body_scope: ast::ScopeId))], outputs::no_unused_labels::LabelUsage[(outputs::no_unused_labels::LabelUsage{.stmt=(_: ast::StmtId), .label_name=(name.data), .scope=(body_scope: ast::ScopeId)}: outputs::no_unused_labels::LabelUsage)]. */
                                                                                                                                   program::Rule::ArrangementRule {
...
pub static __Rule_outputs_no_unused_labels_UsedLabels_1: ::once_cell::sync::Lazy<program::Rule> =
    ::once_cell::sync::Lazy::new(
        || /* outputs::no_unused_labels::UsedLabels[(outputs::no_unused_labels::UsedLabels{.stmt_id=stmt, .label_name=(name.data)}: outputs::no_unused_labels::UsedLabels)] :- outputs::no_unused_labels::__Prefix_1[((file: ast::FileId), (stmt: ast::StmtId), (name: ast::Spanned<ast::Name>), (body_scope: ast::ScopeId))], scopes::ScopeFamily[(scopes::ScopeFamily{.parent=(body_scope: ast::ScopeId), .child=(child_scope: ast::ScopeId)}: scopes::ScopeFamily)], outputs::no_unused_labels::LabelUsage[(outputs::no_unused_labels::LabelUsage{.stmt=(_: ast::StmtId), .label_name=(name.data), .scope=(child_scope: ast::ScopeId)}: outputs::no_unused_labels::LabelUsage)]. */
                                                                                                                                   program::Rule::ArrangementRule {
