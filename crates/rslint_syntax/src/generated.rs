...
impl SyntaxKind {
    pub fn is_keyword(self) -> bool {
        match self {
            ...
            | NAMESPACE_KW | ASSERT_KW | MODULE_KW | GLOBAL_KW => true,
            _ => false,
        }
    }
