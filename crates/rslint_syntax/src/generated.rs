...
impl SyntaxKind {
    pub fn is_keyword(self) -> bool {
        match self {
            ...
            | ABSTRACT_KW | STATIC_KW | ASYNC_KW | TYPE_KW | FROM_KW | AS_KW => true,
            _ => false,
        }
    }
